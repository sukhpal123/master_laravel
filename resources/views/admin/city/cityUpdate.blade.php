        ...
        <div class="row mb-4 mt-4">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ strtolower($page_title) }}">{{ $page_title }}</a>
                    </li>
                    ...
                    <div class="card-block tab-icon">
                        <div class="row">
                            <div class="col-12 text-sm">
                                <form action="{{ route('updateCity', request('id')) }}" method="POST" class="group" id="formUpdateCity">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div id="upurl" data-edit-data-url="{{ route('editData') }}"></div>
                                </form>
                            </div>
                        </div>
                    </div>
