    ...
    $("#addLinkageForm").unbind('submit').bind('submit', function() {
      ...
      var bank_name = $("#bank_name").val();
        ...
        if(bank_name == "") {
                ...
                $("#bank_name").after('<p class="text-danger error-text">Bank Name is required</p>');
        } else {
                $("#bank_name").closest('.form-group').removeClass('has-error');
                $("#bank_name").closest('.form-group').addClass('has-success');                   
        }
      ...
      $.ajax({
        url: 'AppController/getBank',
          ...
          success:function(response) {
            ...
            if(edit_bank_name == "") {
                $("#edit_bank_name").closest('.form-group').addClass('has-error');
                $("#edit_bank_name").after('<p class="text-danger">Id Proof type is required</p>');
            } else {
                $("#edit_bank_name").closest('.form-group').removeClass('has-error');
                $("#edit_bank_name").closest('.form-group').addClass('has-success');                   
            }
            ...
            $.ajax({
                ...
                if(response.success == true) {
                    ...
                    Toast.fire({
                        icon: 'success',
                        title: 'Bank info updated successfully'
                    });
                    });
                    $('#dtBank').DataTable().ajax.reload();
                } else {
